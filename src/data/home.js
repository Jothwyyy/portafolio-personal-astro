export const homePage = {
	...
	sections: {
		one: {
			...
			icons: [
				{ name: 'fa-clock', label: 'Feature 1' },
				{ name: 'solid fa-volume-up', label: 'Feature 2' },
				{ name: 'solid fa-laptop', label: 'Feature 3' },
				{ name: 'solid fa-inbox', label: 'Feature 4' },
				{ name: 'solid fa-lock', label: 'Feature 5' },
				{ name: 'solid fa-cog', label: 'Feature 6' },
			],
		},
		two: {
			items: [
